      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 sm:pt-32 sm:pb-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative lg:h-[700px] flex items-center justify-center">
            ...
            {/* Floating elements */}
            <div className="absolute top-1/4 right-0 w-20 h-20 bg-indigo-500/20 rounded-2xl backdrop-blur-sm border border-indigo-400/30 flex items-center justify-center hero-float" style={{ animationDelay: '0.5s' }}>
              <svg className="w-10 h-10 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            
            <div className="absolute bottom-1/4 left-0 w-24 h-24 bg-purple-500/20 rounded-2xl backdrop-blur-sm border border-purple-400/30 flex items-center justify-center hero-float" style={{ animationDelay: '1s' }}>
